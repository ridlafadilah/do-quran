...
part 'dropdown_popup_menu.dart';
part 'dropdown_select_dialog.dart';
...
class DropdownSearch<T> extends StatefulWidget {
  ...
  ///This will be useful if you want to handle a custom UI only
  ///if the item !=null
...
class DropdownSearchState<T> extends State<DropdownSearch<T>> {
  ...
  ///set true only if the widget already not focused
  ///to prevent unnecessary build
  ...
  ///handle on change value , if the validation is active ,
  ///we validate the new selected item
