...
///
/// To show a popup menu, use the [customShowMenu] function.
...
/// [CustomPopupMenuItem] is kMinInteractiveDimension pixels high.
/// If you use a widget
...
/// keep the text of [CustomPopupMenuItem]s that use [Text] widgets
/// in their [child]
/// slot aligned with the text of [CheckedPopupMenuItem]s
/// or of [CustomPopupMenuItem]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedPopupMenuItem], a variant of [CustomPopupMenuItem]
///  * with a checkmark.
///  * [customShowMenu], a method to dynamically
///  * show a popup menu at a given location.
...
class CustomPopupMenuItem<T> extends PopupMenuEntry<T> {
  ...
  /// The value that will be returned by [customShowMenu]
  ...
  /// If [PopupMenuThemeData.textStyle] is also null,
  /// then [ThemeData.textTheme.subhead] is used.
...
/// [CustomPopupMenuItem]. The first, `T`,
...
class PopupMenuItemState<T, W extends CustomPopupMenuItem<T>> extends State<W> {
  ...
  /// the [CustomPopupMenuItem.value] from
  /// the menu route.
  @protected
  void handleTap() {
...
/// CustomPopupMenuEntry.represents method returns true
/// for `initialValue`, and then
/// summing the values of CustomPopupMenuEntry.height
/// for all the preceding widgets
/// in the list.
///
