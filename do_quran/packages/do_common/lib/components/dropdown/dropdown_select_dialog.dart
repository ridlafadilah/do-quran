...
class _SelectDialogState<T> extends State<SelectDialog<T>> {
  ...
  ///isFirstLoad true if it's the first time we load data from online,
  ///false other wises
  ...
  /// selected item will be highlighted only
  /// when widget.showSelectedItem is true,
  /// if our object is String widget.compareFn is not required,
  /// other wises it's required
