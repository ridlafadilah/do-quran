part of 'package:do_common/components/pin/pin_code_fields.dart';
...
class DialogConfig {
  ...
  /// content of the [AlertDialog] while pasting the code.
  /// Default to ["Do you want to paste this code "]
  ...
  /// should it be iOS or other(including web and Android)
